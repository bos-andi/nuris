        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="vl-page-header-content text-center">
                    <h1 class="vl-page-title">SMP UBQ Nurul Islam</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">SMP UBQ Nurul Islam</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-10 col-xl-9">
                <div class="vl-about-content" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                    <div class="vl-section-title-1 text-center mb-50">
                        ...
                        <h2 class="title text-anime-style-3">SMP UBQ NURUL ISLAM (NURIS)</h2>
                        <p class="mb-0" style="color: #6c757d; font-size: clamp(0.875rem, 1.5vw, 1rem);">Terakreditasi A (93)</p>
                    </div>
                    ...
                    <div class="unit-description" style="background: #ffffff; padding: clamp(2rem, 4vw, 3rem); border-radius: 15px; box-shadow: 0 5px 30px rgba(0,0,0,0.08); margin-bottom: 2rem;">
                        <div style="margin-bottom: 2rem;">
                            ...
                            <p style="color: #495057; line-height: 1.8; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); margin-bottom: 0;">
                                Desa Tunggalpager Kecamatan Pungging<br>
                        ...
                        <div style="margin-bottom: 2rem;">
                            ...
                            <p style="color: #495057; line-height: 1.8; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); margin-bottom: 0;">
                                H. Muhammad Ikhsan, S. Kom., S.Pd., MM.
                            </p>
                        </div>
                        ...
                        <div style="border-top: 2px solid #e9ecef; padding-top: 2rem; margin-top: 2rem;">
                            <p style="color: #495057; line-height: 1.9; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); text-align: justify; margin-bottom: 1.5rem;">
                                Sebagai lembaga pendidikan yang menyuguhkan Sistem Pendidikan Kolaboratif yaitu memadu padankan Sistem Formal dan Diniyah Salafiyah, SMP UBQ Nurul Islam sesuai dengan namanya mengkonsentrasikan Peserta Didik dengan Program Ulumul Qur'an dan Tahfidhul Qur'an. Dua program pokok tersebut terkolaborasi dengan 7 Program Expert Class, meliputi : International Class Program (ICP), Bilingual Class (BC), Kutub At-Turots Islami (KTI), Dirosah Islamiyah (DI), Math and Science (MSC), Social Class (SC) dan Sport Class (SP).
                            </p>
                            <p style="color: #495057; line-height: 1.9; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); text-align: justify; margin-bottom: 0;">
                                Untuk mencapai tujuan mulia tersebut pembelajaran di SMP UBQ NURUL ISLAM dikelola dengan Manajemen Mix (kolaboratif) yang melibatkan Guru/Asatidz yang kompeten dibidangnya.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="instagram-link-section text-center" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: clamp(1.5rem, 3vw, 2rem); border-radius: 15px; box-shadow: 0 5px 30px rgba(102, 126, 234, 0.3);">
                        ...
                        <p style="color: rgba(255,255,255,0.9); margin-bottom: 1.5rem; font-size: clamp(0.875rem, 1.5vw, 1rem);">
                            Dapatkan update terbaru tentang kegiatan dan informasi SMP UBQ Nurul Islam
                        </p>
                        <a href="https://www.instagram.com/smpubq.nuris/" target="_blank" rel="noopener noreferrer" 
