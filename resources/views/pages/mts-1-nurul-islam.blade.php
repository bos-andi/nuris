        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="vl-page-header-content text-center">
                    <h1 class="vl-page-title">MTs 1 Nurul Islam</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">MTs 1 Nurul Islam</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-10 col-xl-9">
                <div class="vl-about-content" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                    <div class="vl-section-title-1 text-center mb-50">
                        ...
                        <h2 class="title text-anime-style-3">MTs Nurul Islam</h2>
                    ...
                    <div class="unit-description" style="background: #ffffff; padding: clamp(2rem, 4vw, 3rem); border-radius: 15px; box-shadow: 0 5px 30px rgba(0,0,0,0.08); margin-bottom: 2rem;">
                        <div style="margin-bottom: 2rem;">
                            ...
                            <p style="color: #495057; line-height: 1.8; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); margin-bottom: 0;">
                                Desa Jabontegal Kecamatan Pungging<br>
                        ...
                        <div style="margin-bottom: 2rem;">
                            ...
                            <p style="color: #495057; line-height: 1.8; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); margin-bottom: 0;">
                                H. Muhammad Ikhsan, S. Kom., S.Pd., M.M.
                            </p>
                        </div>
                        ...
                        <div style="border-top: 2px solid #e9ecef; padding-top: 2rem; margin-top: 2rem;">
                            <p style="color: #495057; line-height: 1.9; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); text-align: justify; margin-bottom: 1.5rem;">
                                Mts Nurul Islam didirikan tahun 2010 tepatnya pada tanggal 17 Juni setelah selang beberapa waktu berdirinya YPP Nurul Islam yang dirintis dan diasuh Dr. KH. Ahmad Siddiq, S.E., M.M.
                            </p>
                            <p style="color: #495057; line-height: 1.9; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); text-align: justify; margin-bottom: 1.5rem;">
                                Dengan apik Lembaga Pendidikan ini menyongsong kurikulum kolaborasi untuk pemantapan sistem pembelajaran bagi anak didik, yakni dengan program yang dikemas dalam gaya pembelajaran kolaborasi Metode Salafiyah dengan Metode Pendidikan Nasional yang unggul dan adaptif. Sistem Pembelajaran Internasional yang terangkai Program Expert Class sehingga suitable dengan Pendidikan Karakter Global PP Nurul Islam.
                            </p>
                            <p style="color: #495057; line-height: 1.9; font-size: clamp(0.9375rem, 1.6vw, 1.0625rem); text-align: justify; margin-bottom: 0;">
                                Seiring perkembangan zaman, MTS. Nurul Islam semakin memantapkan harapan umat dengan berbagai prestasi yang di capainya di Tahun 2022, Peraih Medali Emas di ajang OSN Mapel Bahasa Indonesia Tingkat Nasional.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="instagram-link-section text-center" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: clamp(1.5rem, 3vw, 2rem); border-radius: 15px; box-shadow: 0 5px 30px rgba(102, 126, 234, 0.3);">
                        ...
                        <p style="color: rgba(255,255,255,0.9); margin-bottom: 1.5rem; font-size: clamp(0.875rem, 1.5vw, 1rem);">
                            Dapatkan update terbaru tentang kegiatan dan informasi MTs 1 Nurul Islam
                        </p>
                        <a href="https://www.instagram.com/mts.nuris.id/" target="_blank" rel="noopener noreferrer" 
