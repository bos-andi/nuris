<header class="app-header flex items-center px-4 gap-3">
    ...
    <a href="{{ route('admin.dashboard') }}" class="logo-box flex items-center gap-2">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('admin.system-update.index') }}" class="nav-link p-2 relative group" title="Update System Online" style="position: relative;">
            <span class="flex items-center justify-center h-6 w-6">
        ...
        <div class="relative">
            ...
            <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-0 w-48 z-50 mt-2 transition-[margin,opacity] duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2">
                <div class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <span class="text-xs px-2 py-1 bg-primary/10 text-primary rounded mt-1 inline-block">{{ ucfirst(auth()->user()->role) }}</span>
                </div>
