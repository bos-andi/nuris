...
@section('content')
<div class="mb-6">
    <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Tambah Tag Baru</h4>
    <p class="text-sm text-gray-500 dark:text-gray-400">Tambah tag baru untuk berita</p>
</div>
