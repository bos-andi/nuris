...
@section('title', 'Edit Pengurus Dewan Pusat')

@section('content')
<div class="mb-6">
    <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Edit Pengurus Dewan Pusat</h4>
    <p class="text-sm text-gray-500 dark:text-gray-400">Edit data pengurus dewan pusat</p>
</div>

<div class="card">
    <div class="p-6">
        <form action="{{ route('admin.pengurus-dewan-pusat.update', $pengurus->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" id="jabatan_lengkap" name="jabatan_lengkap" class="form-input w-full" value="{{ old('jabatan_lengkap', $pengurus->jabatan_lengkap) }}" placeholder="Contoh: Ketua Dewan Pengurus Pusat PP. Nurul Islam">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="kategori" name="kategori" class="form-input w-full" value="{{ old('kategori', $pengurus->kategori) }}" placeholder="Contoh: Pengurus Pusat Nuris 1, Pengurus Pusat Nuris 2">
            ...
            <div class="flex justify-end gap-2">
                <a href="{{ route('admin.pengurus-dewan-pusat') }}" class="btn bg-gray-500 text-white">Batal</a>
