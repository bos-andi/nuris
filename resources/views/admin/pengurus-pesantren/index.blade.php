...
@section('title', 'Kelola Pengurus Pesantren')

@section('content')
<div class="flex justify-between items-center mb-6">
    <div>
        <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Kelola Pengurus Pesantren</h4>
        <p class="text-sm text-gray-500 dark:text-gray-400">Daftar semua pengurus pesantren yang ditampilkan di halaman publik</p>
    </div>
    <a href="{{ route('admin.pengurus-pesantren.create') }}" class="btn bg-primary text-white">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td class="py-3 px-4">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('admin.pengurus-pesantren.edit', $p->id) }}" class="btn btn-sm bg-warning text-white">
                                    <i class="mgc_edit_line"></i>
                                </a>
                                <a href="{{ route('admin.pengurus-pesantren.delete', $p->id) }}" class="btn btn-sm bg-danger text-white" onclick="return confirm('Apakah Anda yakin ingin menghapus pengurus ini?');">
                    ...
                    <tr>
                        <td colspan="7" class="py-8 text-center text-gray-500">
                            Belum ada data pengurus pesantren. <a href="{{ route('admin.pengurus-pesantren.create') }}" class="text-primary">Tambah pengurus pertama</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
