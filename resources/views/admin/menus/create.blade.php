...
@section('content')
<div class="mb-6">
    <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Buat Menu Baru</h4>
    <p class="text-sm text-gray-500 dark:text-gray-400">Tambah menu baru ke navigasi website</p>
</div>
        ...
        <form action="{{ route('admin.menus.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select id="type" name="type" class="form-select w-full" required onchange="toggleMenuFields()">
                    <option value="page" {{ old('type') == 'page' ? 'selected' : '' }}>Halaman</option>
            ...
            <div class="grid md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="number" id="order" name="order" class="form-input w-full" value="{{ old('order', 0) }}">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" id="icon" name="icon" class="form-input w-full" value="{{ old('icon') }}" placeholder="mgc_home_3_line">
                ...
                <div>
                    ...
                    <select id="target" name="target" class="form-select w-full">
                        <option value="_self" {{ old('target', '_self') == '_self' ? 'selected' : '' }}>Tab yang sama</option>
