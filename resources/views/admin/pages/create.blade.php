...
@section('content')
<div class="mb-6">
    <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Buat Halaman Baru</h4>
    <p class="text-sm text-gray-500 dark:text-gray-400">Tambah halaman baru ke website</p>
</div>
