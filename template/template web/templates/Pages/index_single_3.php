...
<head>
    <?= $this->element('title_meta', array('title' => 'Helpy || 3', 'logo3' => true)) ?>
...
<body class="homepage1-body">
    ...
    <?= $this->element('loader', array('logo3' => true)) ?>
            ...
            <div class="row">
                <div class="col-lg-8 gx-0">
                    <div class="vl-section-heading3">
                        ...
                        <div class="vl-btn3">
                            <a href="contact" class="primary-btn-3">Join The Relief Effort</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="vl-about-thumb-flex mb-30">
                        <a href="about"><span><img src="/img/icons/vl-up-arrow.svg" alt=""></span></a>
                        <div class="row">
                    ...
                    <div class="vl-about-content-3 ml-50 mb-30">
                        <div class="vl-section-title3">
                            ...
                            <div class="vl-btn3" data-aos="fade-left" data-aos-duration="1100" data-aos-delay="300">
                                <a href="event" class="primary-btn-3">let's see work</a>
                            </div>
                        </div>
                    ...
                    <div class="vl-service-box-parent mb-30">
                        ...
                        <div class="vl-service-box-3">
                            ...
                            <div class="service-content">
                                <a href="service" class="title">Education Support</a>
                                <p class="para">Explore charity website discover impactful projects, opportunities.</p>
                                <a href="service" class="rmore">Read More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1100" data-aos-delay="300">
                    <div class="vl-service-box-parent mb-30">
                        ...
                        <div class="vl-service-box-3">
                            ...
                            <div class="service-content">
                                <a href="service" class="title">Healthy Foods</a>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
                    <div class="vl-service-box-parent mb-30">
                        ...
                        <div class="vl-service-box-3">
                            ...
                            <div class="service-content">
                                <a href="service" class="title">Medical Help</a>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="author-area">
                                    <div class="heading pl-20">
                                        <a href="team" class="title">Leslie Alexander</a>
                    ...
                    <div class="vl-single-blog-item mr-15 mb-30">
                        ...
                        <div class="vl-blog-content">
                            ...
                            <div class="vl-content">
                                <a href="blog-single" class="title">Innovative Solutions for Water Scarcity</a>
                ...
                <div class="col-lg-7 gx-0">
                    ...
                    <div class="vl-single-blog-item ml-15 mb-30">
                        ...
                        <div class="vl-blog-content">
                            ...
                            <div class="vl-content">
                                <a href="blog-single" class="title">Clean Water, Healthy Futures: The Impact of Safe Water</a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="vl-cta-content3 mb-30">
                            ...
                            <div class="cta-btn">
                                <a href="contact" class="cta-btn1">Help Provide Water</a>
                                <a href="contact" class="cta-btn2">Donate Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="vl-footer-widget-1 mb-30">
                        <div class="vl-footer-logo">
                            <a href="index-3"><img src="/img/logo/vl-footer-logo-1.1.png" alt=""></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="vl-footer-widget-2 pl-90 mb-30">
                        ...
                        <div class="vl-footer-menu">
                            <ul>
                                <li><a href="index-3">Home Page</a></li>
