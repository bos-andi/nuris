...
<head>
    <?= $this->element('title_meta', array('title' => 'Event')) ?>
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex active">
                        ...
                        <div class="event-content">
                            ...
                            <a href="event-single" class="title">Unity Giving Community Charity Event</a>
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href="event-single" class="title">Harmony of Hearts Charity Concert content</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href="event-single" class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href="event-single" class="title">Empowerment through Giving Charity Ball</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href="event-single" class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href="event-single" class="title">Spread the Love Charity Art Exhibition</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href="event-single" class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href="event-single" class="title">Lives Golf Charity Networking Event</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href="event-single" class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href="event-single" class="title">Shine for a Cause Charity Dinner & Auction</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href="event-right" class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
